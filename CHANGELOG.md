...
### Added
- **Cross-platform intelligence** — new [bridge-mcp-server](https://github.com/nodeblue-ai/bridge-mcp-server) package correlates Ignition OPC tags with Studio 5000 L5X PLC logic end-to-end.
